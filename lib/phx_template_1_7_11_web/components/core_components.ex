defmodule PhxTemplate1711Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxTemplate1711Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxTemplate1711Web.Gettext, "errors", msg, opts)
    end
  end
